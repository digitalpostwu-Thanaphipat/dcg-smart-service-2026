...
* **กิจกรรมหลักและการดำเนินการ:**
  ...
  * **[Data Migration & Go-Live Setup — 🟡 กำลังดำเนินการ]:**
    ...
    * **จัดทำสคริปต์โอนย้ายข้อมูลอัตโนมัติ:** พัฒนาไฟล์ [scratch/migration_script.gs](file:///D:/[DEV] __WUS_Track_DB/scratch/migration_script.gs) และนำไปฝัง ID สเปรดชีตเดิมเพื่อเตรียมรันบนระบบ Apps Script ของสเปรดชีตใหม่ ทำให้ข้อมูลในประวัติถูกแปลงเป็น V2 Schema ครบถ้วน 100%
...
* **สถานะความคืบหน้า:** แจ้งระงับการบันทึกข้อมูลในระบบเดิมแล้ว และเตรียมการรันสคริปต์ย้ายข้อมูลเพื่อโอนย้ายข้อมูลธุรกรรมทั้งหมดจากระบบเก่าเข้าสู่ระบบ V2 ใหม่
